...
public class User {
	...
	public User( String firstName, String lastName, String email, String password, Date birth, int status,
			String role) {
		//this.id = id;
	...
	public User(int id, String firstName, String lastName, String email, String password, int status,
			String role) {
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
